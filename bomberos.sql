...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-02-2026 a las 19:39:39
...
(21, '2025-01-01', '19:16:19', 'ENTRADA', 4),
(22, '2025-01-01', '21:17:16', 'SALIDA', 4),
(23, '2025-01-02', '22:39:05', 'ENTRADA', 4),
(24, '2025-01-03', '06:00:00', 'SALIDA', 4),
(25, '2025-03-13', '06:00:00', 'ENTRADA', 5),
(26, '2025-03-13', '14:00:00', 'SALIDA', 5),
(27, '2025-03-14', '22:04:00', 'ENTRADA', 5),
(28, '2025-03-15', '05:00:00', 'SALIDA', 5);
...
CREATE TABLE `personal` (
  ...
  `clave_bombero` varchar(6) NOT NULL,
...
(4, 'A1302', '123456', 'jorge luis', 'marin roque', 'Seccionario', 'Activo'),
(5, 'EA4040', '123456', 'denys', 'davila', 'Seccionario', 'Activo');
...
--
ALTER TABLE `control`
  MODIFY `idcontrol` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
